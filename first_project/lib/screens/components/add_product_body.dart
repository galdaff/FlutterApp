              ...
              children: <Widget>[
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText:
                        nameValidate ? 'Product Name can\'t be empty' : null,
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText:
                        manuValidate ? 'Manufacturer can\'t be empty' : null,
                    labelStyle: TextStyle(
                      fontSize: 20.0,
                      color: Colors.grey,
                    ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText:
                        sizeValidate ? 'Shoes size can\'t be empty' : null,
                    labelStyle: TextStyle(
                      fontSize: 20.0,
                      color: Colors.grey,
                    ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: 'Category',
                    errorText: cateValidate ? 'Category can\'t be empty' : null,
                    labelStyle: TextStyle(
                      fontSize: 20.0,
                      color: Colors.grey,
                    ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText:
                        descriptValidate ? 'Description can\'t be empty' : null,
                    labelStyle: TextStyle(
                      fontSize: 20.0,
                      color: Colors.grey,
                    ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: 'Quantity',
                    errorText:
                        quantityValidate ? 'Quantity can\'t be empty' : null,
                    labelStyle: TextStyle(
                      fontSize: 20.0,
                      color: Colors.grey,
                    ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    labelText: 'Status',
                    errorText: statusValidate ? 'Status can\'t be empty' : null,
                    labelStyle: TextStyle(
                      fontSize: 20.0,
                      color: Colors.grey,
                    ),
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    errorText:
                        priceValidate ? 'Shoes price can\'t be empty' : null,
                    labelStyle: TextStyle(
                      fontSize: 20.0,
                      color: Colors.grey,
                    ),
                      ...
                      if (nameController.text.isEmpty &&
                        ...
                        productBloc.add(
                          AddButtonPressed(
                            ...
                            status: int.parse(statusController.text.toString()),
